    ...
    variants: [
      {
        name: 'Black Bay 58',
        description:
          "39mm heritage diver with Tudor's MT5402 manufacture calibre.",
        color: 'Black',
        price: 395_000,
        stockQuantity: 6,
      ...
      },
      {
        ...
        description:
          'Limited burgundy bezel pairing on the 39mm Black Bay 58 case.',
        color: 'Burgundy',
        price: 415_000,
        stockQuantity: 2,
        assetUrls: [IMG.blackBay58],
    ...
    variants: [
      {
        name: 'Pelagos FXD',
        description:
          'Titanium dive watch developed with the French Marine Nationale.',
        color: 'Blue',
        price: 410_000,
        stockQuantity: 3,
    ...
    variants: [
      {
        ...
        description:
          '300m dive watch with the original Professional orange dial.',
        color: 'Orange',
        price: 249_000,
        stockQuantity: 8,
    ...
    variants: [
      {
        ...
        description:
          'Reverse-panda chronograph with column-wheel architecture.',
        color: 'White',
        price: 219_500,
        stockQuantity: 3,
    ...
    variants: [
      {
        ...
        description:
          '300m diver with ceramic bezel and a sunray-finished dial.',
        color: 'Blue',
        price: 170_000,
        stockQuantity: 7,
    ...
    variants: [
      {
        ...
        description:
          '40mm pointer-date with a coin-edge bezel and bronze accents.',
        color: 'Brown',
        price: 210_000,
        stockQuantity: 4,
